...
<div class="col-sm-7">
<div class="bg-img">
<div class="text"> <b>Retrive password !!!</b></div>
<p style="text-align:center"><b>Welcome to OneClicQ Vendor Panel</b></p>
<div class="login">
<form method="post" action="/vendorforgot">
@csrf
    <input type="text" class="form-control" placeholder="Enter your Mobile no" name="mob">
    @error("mob")
<p style="color:red">{{$errors->first("mob","Mobile no is required")}}</p>
@enderror    
