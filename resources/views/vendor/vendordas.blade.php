  ...
  <aside class="main-sidebar sidebar-dark-warning elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="image">
        ...
        <div class="info">
        <form method="get" action="/vendorbody"enctype="multipart/form-data">
    @csrf
    @foreach($result as $value)

    <p style="color:white">
    &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp &nbsp&nbsp<b>Hi, </b>{{$value->name}}</p>
    @endforeach
</form> 
        </div>
      </div>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open">
            <a href="/vendorbody" class="nav-link active">
