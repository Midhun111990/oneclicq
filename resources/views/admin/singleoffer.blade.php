...
@section('body')
  ...
  <div class="content-wrapper">
    ...
    <form id="agreeproduct_form" novalidate action="/approveoffer/{{$value->offerid}}"  method="post" class="brand" enctype="multipart/form-data"> 
      ...
      <div class="container-fluid">
        <div class="row">
              ...
              <div class="card-body p-1">
               <table class="table table-bordered">
                  ...
                  <tbody>
                    ...
                    <tr>
                    <td colspan="3"><input type="submit" name="submit" class="submit btn btn-success" value="Approve🤘" style="height:50px;width:408px;font-size: 25px;"> 
</td>
                    </tr>
                  </tbody>
                </table>
          ...
          <div class="card">
              ...
              <div class="card-header">
              <a href="/rejectoffer/{{$value->offerid}}"><h1> 
 <p style="color:red"><b>&nbsp&nbsp
