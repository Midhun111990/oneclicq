...
<p><b>Login</b></p> </div>
<p style="text-align:center"><b>Welcome to OneClicQ Customer's Panel</b></p>
<div class="login">
<form method="post" action="/customersignin">
@csrf
...
@enderror 
    ...
    <span>   <a href="/customerregistration"><b style="color:white;">New registeration !!!</p></b></a>
</span>
